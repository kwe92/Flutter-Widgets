...
import 'package:flutter_widgets/Widgets/table_calendar/calendar_event_example_view_model.dart';
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: ListTile(
                        onTap: () => print('${model.selectedEvents[index]}'),
                        title: Text('${model.selectedEvents[index]}'),
                      ),
                    );
                  },
                ),
...
// class TableEventsExampleView extends StatefulWidget {
//   @override
//   _TableEventsExampleState createState() => _TableEventsExampleState();
// }

// class _TableEventsExampleState extends State<TableEventsExampleView> {
