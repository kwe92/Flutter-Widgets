...
void main() {
  runApp(const ExampleFromFlutterPortalDocs00());
}

class ExampleFromFlutterPortalDocs00 extends StatefulWidget {
  const ExampleFromFlutterPortalDocs00({Key? key}) : super(key: key);

  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<ExampleFromFlutterPortalDocs00> {
