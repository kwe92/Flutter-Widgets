...
//     - you can name the variable whatever you want (`locator` is my choosen name for my GetIt service locator variable)

// How to Use get_it Service Locator

//   1: assign GetIt.instance to global variable
//   2.a: implement a function to register services to GetIt.instance variable (i name the function configureDependencies)
...
//     - I prefer to access registered objects by using global getter method computed variables